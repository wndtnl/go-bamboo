...
func (s *LinkedRepositoryPermissionService) GetAll(repositoryId int) ([]*LinkedRepositoryPermission, error) {
	return s.GetAllWithContext(context.Background(), repositoryId)
}

func (s *LinkedRepositoryPermissionService) GetAllWithContext(
	ctx context.Context, repositoryId int) ([]*LinkedRepositoryPermission, error) {

	endpoint := fmt.Sprintf("%s/%d", linkedRepositoryPermissionEndpoint, repositoryId)
...
func (s *LinkedRepositoryPermissionService) GetOne(repositoryId int, permissionType, name string) (*LinkedRepositoryPermission, error) {
...
func (s *LinkedRepositoryPermissionService) GetOneWithContext(
	ctx context.Context, repositoryId int, permissionType, name string) (*LinkedRepositoryPermission, error) {

	endpoint := fmt.Sprintf("%s/%d/%s/%s",
...
func (s *LinkedRepositoryPermissionService) Delete(repositoryId int, permissionType, name string) error {
	return s.DeleteWithContext(context.Background(), repositoryId, permissionType, name)
}

func (s *LinkedRepositoryPermissionService) DeleteWithContext(ctx context.Context, repositoryId int, permissionType, name string) error {

	endpoint := fmt.Sprintf(
		"%s/%d/%s/%s", linkedRepositoryPermissionEndpoint, repositoryId, permissionType, url.PathEscape(name))
